                ...
                case (int)MainMenuItems.Continue:
                    {
                        var tempControl =
                        CreateControl(Interface.InterfaceResources.ButtonPrefab,
                        LangManager.Instance.Text("MainMenuItems", "Continue"));
                ...
                case (int)MainMenuItems.Options:
                    {
                        var tempControl =
                        CreateControl(Interface.InterfaceResources.ButtonPrefab,
                        LangManager.Instance.Text("MainMenuItems", "Options"));
                ...
                case (int)MainMenuItems.Quit:
                    {
                        var tempControl =
                        CreateControl(Interface.InterfaceResources.ButtonPrefab,
                        LangManager.Instance.Text("MainMenuItems", "Quit"));
